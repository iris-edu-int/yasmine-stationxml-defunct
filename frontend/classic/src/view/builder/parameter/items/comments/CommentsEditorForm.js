Ext.define('imct.view.xml.builder.parameter.items.comments.CommentsEditorForm', {
    extend: 'Ext.window.Window',
    xtype: 'comments-editor-form',
    requires: ['imct.view.xml.builder.parameter.items.comments.CommentsEditorFormModel',
        'imct.view.xml.builder.parameter.items.comments.CommentsEditorFormController'],
