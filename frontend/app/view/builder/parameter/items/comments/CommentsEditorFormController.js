Ext.define('yasmine.view.xml.builder.parameter.items.comments.CommentsEditorFormController', {
    ...
    initData: function (record) {
        ...
        this.getViewModel().set('beginEffectiveTime', Ext.Date.parse(record.get('_begin_effective_time'), yasmine.Globals.DateReadFormat, true));
        this.getViewModel().set('endEffectiveTime', Ext.Date.parse(record.get('_end_effective_time'), yasmine.Globals.DateReadFormat, true));
    ...
    onSaveClick: function () {
        ...
        record.set('_begin_effective_time', Ext.Date.format(this.getViewModel().get('beginEffectiveTime'), yasmine.Globals.DateReadFormat));
        record.set('_end_effective_time', Ext.Date.format(this.getViewModel().get('endEffectiveTime'), yasmine.Globals.DateReadFormat));
